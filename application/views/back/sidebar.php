  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php if($this->uri->segment(2) == "lapangan"){echo "class='active'";} ?>>
        <a href='#'><i class='fa fa-list'></i><span> KOLAM RENANG </span><i class='fa fa-angle-left pull-right'></i></a>
        <ul class='treeview-menu'>
          <li <?php if($this->uri->segment(2) == "lapangan" && $this->uri->segment(3) == "create"){echo "class='active'";} ?>><a href='<?php echo base_url('admin/lapangan/create') ?>'><i class='fa fa-circle-o'></i> Tambah Kolam Renang </a></li>
          <li <?php if($this->uri->segment(2) == "lapangan" && $this->uri->segment(3) == ""){echo "class='active'";} ?>><a href='<?php echo base_url('admin/lapangan') ?>'><i class='fa fa-circle-o'></i> Data Kolam Renang </a></li>
        </ul>
      </li>
