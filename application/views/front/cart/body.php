...
<div class="container">
    <div class="row">
                ...
                <?php if (!empty($customer_data->id_trans)) { ?>
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php if ($cek_keranjang != NULL) { ?>
                                <button name="checkout" type="submit" class="btn btn-success" aria-label="Left Align" title="Checkout" id="pay-button">
        ...
        <script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-a3XBeF6t11TJ5LWQ">
        </script>
        ...
        <!-- <script>
            function showCell() {
                var sTableName = document.getElementById("datatable");
