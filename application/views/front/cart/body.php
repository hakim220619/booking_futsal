    ...
    <div class="row">
        <div class="col-lg-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo base_url() ?>"><i class="fa fa-home"></i> Home</a>
                    </li>
        ...
        <div class="col-lg-12">
            ...
            <hr>
            <form action="<?php echo base_url('cart/checkout') ?>" id="payment-form" method="post">
                        ...
                        <div class="box-body table-responsive padding">
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="text-align:left" class="nama_lapangan" id="nama_lapangan">
                                            <?php echo $cart->nama_lapangan ?></td>
                                        <td style="text-align:center" class="harga_per_jam">
                                            <?php echo number_format($cart->harga) ?></td>
                                        <td style="text-align:center">
                                            ...
                                            <input type="hidden" name="lapangan[]"
                                                value="<?php echo $cart->lapangan_id ?>">
                                            <input type="hidden" name="id_transdet[]"
                                                value="<?php echo $cart->id_transdet ?>">
                                            <input type="hidden" value="<?php echo $cart->lapangan_id; ?>"
                                                class="lapangan_id">
                                        </td>
                                        <td style="text-align:center">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="<?php echo base_url() ?>">
                            <button name="hapus" type="button" class="btn btn-primary" aria-label="Left Align"
                                title="Lanjut Belanja">
                                <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Lanjut
                                Belanja
                            </button>
                        </a>
                        <?php if ($cek_keranjang != NULL) { ?>
                        <button name="checkout" type="submit" class="btn btn-success" aria-label="Left Align"
                            title="Checkout" id="pay-button">
        ...
        <script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js"
            data-client-key="SB-Mid-client-a3XBeF6t11TJ5LWQ">
        </script>
        ...
        $(function() {
            ...
            $('.tanggal').on('changeDate', function(ev) {
                ...
                $.post('<?php echo base_url(); ?>Cart/getJamMulai', {
                        ...
                        jam_mulai_el.append(
                            "<option value='' selected='selected'>- Pilih Jam Mulai -</option>");

                        count = 0;

                        data.forEach(function(item, index) {
                            // console.log(item);
                            jam_mulai_el.append("<option durasi='" + item.durasi + "'>" +
                                item.jam_mulai + "</option>");
                            count++;
                        });
                        ...
                        if (count == 0) {
                            jam_mulai_el.html("");
                            jam_mulai_el.append(
                                "<option value='' selected='selected'>- Tidak ada pilihan -</option>"
                            );
                        }
            ...
            $(document).on("change keyup", ".durasi", function() {
                ...
                if (jam_mulai_el.val() != "") {
                    jam_selesai = moment("01-01-2018 " + jam_mulai_el.val(), "MM-DD-YYYY HH:mm:ss").add(
                        parseInt(durasi), 'hours').format('HH:mm:ss');
        ...
        $('#pay-button').click(function(event) {
            ...
            var text = $(this).find('td:nama_lapangan')[0].innerText;
            console.log(text);
            $.ajax({
                ...
                data: {
                    ...
                    nama_lapangan: $('#nama_lapangan').text(),
                },
