...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<hr>
			<h4>INVOICE NO. <?php echo $cart_finished_row->id_invoice ?> (<?php if ($cart_finished_row->status != 1) { ?>
			...
			<?php if ($cart_finished_row->status != 1) { ?>
				<a href="<?= $cart_finished_row->pdf_url ?>" class="btn btn-sm btn-danger" target="_blank">Bayar</a>
			<?php } ?>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<hr>
					<ul>
						<li>Segera lakukan pembayaran sebelum: <b><?php $time = strtotime($cart_finished_row->deadline);
																	echo date("d F Y | H:i:s", $time); ?> WIB</b>, apabila melewati batas waktu tersebut maka booking dianggap batal.</li>
